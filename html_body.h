const char HTML_BODY[] =
 "<!DOCTYPE html>"
    ...
    "<body>"
    "<div class=\"container\">"
    "<h1 class=\"title\">💧 Controle de Umidade</h1>"
    "<div class=\"tank\">"
    ...
    "water.style.height=data.nivel_atual_Umid+'%';"
    "levelText.textContent=data.nivel_atual_Umid+'%';"
    "maxLimit.style.bottom=data.max_umid+'%';"
    "minLimit.style.bottom=data.min_umid+'%';"
    "maxLimit.setAttribute('data-label','MAX: '+data.max_umid+'%');"
    "minLimit.setAttribute('data-label','MIN: '+data.min_umid+'%');"
    "if(document.activeElement!==minInput)minInput.value=data.min_umid;"
    "if(document.activeElement!==maxInput)maxInput.value=data.max_umid;"
    "}"
    ...
    "}"
    "try{"
    "const res=await fetch('/api/limites/umidade',{"
    "method:'POST',"
